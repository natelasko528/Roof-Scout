import { Component, ChangeDetectionStrategy, ElementRef, viewChild, effect, inject, input, output, untracked, signal, OnDestroy } from '@angular/core';
...
export class InteractiveMapComponent implements OnDestroy {
  ...
  constructor() {
    this.loadCache();
    this.createTimeout(() => this.initMap(), 0);
